...
const AA: [u64; 93] = [
    4294967295, 138, 1498001188, 211147047, 253, 0, 203, 288, 9, 1196819126, 3212677781, 135, 263,
    193, 58, 18, 244, 2931180889, 240, 173, 268, 2157053261, 261, 175, 14, 5, 171, 270, 156, 258,
    13, 15, 3732962506, 185, 169, 2, 6, 132, 162, 200, 3, 160, 217618912, 62, 2517678443, 44, 164,
    4, 96, 183, 2903579748, 3863347763, 119, 181, 10, 190, 8, 2654435769, 259, 104, 230, 128,
    2633865432, 225, 1, 257, 143, 179, 16, 600974999, 185100057, 32, 188, 53, 2718276124, 177, 196,
    4294967296, 147, 117, 17, 49, 7, 28, 12, 266, 216, 11, 0, 45, 166, 247, 1451689750,
];
...
fn custom_b64_encode(bytes: &[u8]) -> String {
    ...
    let mut i = 0usize;
    while i < full_len {
        let block = ((bytes[i] as u32) << 16) | ((bytes[i + 1] as u32) << 8) | bytes[i + 2] as u32;
